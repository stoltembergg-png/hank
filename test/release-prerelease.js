...
test('AC-632: milestone promotion converts only the matching prerelease manifest', () => {
...
test('AC-633: milestone release workflow is explicit and sources the version map', () => {
