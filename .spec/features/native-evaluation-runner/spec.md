...
### US-1461 — Executar o corpus em ambiente versionado
...
#### AC-1471 — Baseline PASS registra identidade e métricas
...
### US-1462 — Rejeitar ambientes incomparáveis
...
#### AC-1472 — SHA, árvore, policy, schema ou ambiente divergente falham fechado
...
### US-1463 — Impedir execução insegura ou evidência incompleta
...
#### AC-1473 — Artifact ausente, fixture não determinística e efeito externo falham fechado
...
### US-1464 — Manter boundedness e replay idempotente
...
#### AC-1474 — Limites, saída e idempotência são verificáveis
