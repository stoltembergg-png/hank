...
- Refs: US-2500, AC-2501, AC-2502, AC-2503, AC-2504, AC-2505
- Arquivos: `tools/security/agent-loop-feature-tests.mjs`, `docs/agent-loop-tests.md`, `.github/workflows/ci-agent-loop.yml`, `.github/workflows/onp-sdd-evidence.yml`, `onpspec.config.json`
