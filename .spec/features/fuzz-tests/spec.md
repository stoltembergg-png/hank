...
- **Então** cada FT-NNN deve corresponder a um `FuzzTarget` Rust registrado em `crates/test-support/src/fuzz.rs`, com nome, kind permitido, parser puro, invariants e `smoke_iterations` maior ou igual a 8.
