...
## T-001 — Consolidar baseline normativo W0 [pendente]
...
## T-002 — Definir contrato de fronteiras e ownership [pendente]
...
## T-003 — Definir schema e validator da fila/DAG [pendente]
...
## T-004 — Definir PR Execution Contract e evidence manifest [pendente]
...
## T-005 — Definir gate negativo e matriz de fechamento [pendente]
...
## T-006 — Auditar especificação ONP e evidência W0 [pendente]
