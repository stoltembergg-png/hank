...
- [x] **Step 1: Write failing evaluator tests** for safe pass, baseline immutability, regression, injection/quarantine, budget exhaustion, timeout, inconclusive/flaky evidence, rerun dedupe and tampered report rejection.
